...
class Settings(BaseSettings):
    ...
    claude_allowed_tools: Optional[List[str]] = Field(
        default=[
            ...
            "mcp__workspace-mcp__batch_modify_gmail_message_labels",
            ...
            "mcp__workspace-mcp__get_drive_file_download_url",
            ...
            "mcp__workspace-mcp__get_drive_file_permissions",
            "mcp__workspace-mcp__check_drive_file_public_access",
            ...
            "mcp__workspace-mcp__list_task_lists",
            "mcp__workspace-mcp__get_task_list",
            "mcp__workspace-mcp__manage_task_list",
            "mcp__workspace-mcp__list_tasks",
            "mcp__workspace-mcp__get_task",
            "mcp__workspace-mcp__manage_task",
        ],
